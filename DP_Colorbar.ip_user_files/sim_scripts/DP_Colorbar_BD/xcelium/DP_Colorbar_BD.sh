...
#
# Script generated by Vivado on Tue Apr 02 13:58:15 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DP_Colorbar_BD.sh
...
#
# Usage        : DP_Colorbar_BD.sh
#                DP_Colorbar_BD.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DP_Colorbar_BD.sh [-reset_run]
#                DP_Colorbar_BD.sh [-reset_log]
#                DP_Colorbar_BD.sh [-help]
#
...
#                script (type 'DP_Colorbar_BD.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_15 -libname zynq_ultra_ps_e_vip_v1_0_15 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_15 zynq_ultra_ps_e_vip_v1_0_15 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "DP_Colorbar_BD.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DP_Colorbar_BD.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work zynq_ultra_ps_e_vip_v1_0_15 $xmvlog_opts -sv +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DP_Colorbar_BD xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DP_Colorbar_BD -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DP_Colorbar_BD_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DP_Colorbar_BD.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DP_Colorbar_BD.sh [-help]\n\
Usage: DP_Colorbar_BD.sh [-step]\n\
Usage: DP_Colorbar_BD.sh [-lib_map_path]\n\
Usage: DP_Colorbar_BD.sh [-reset_run]\n\
Usage: DP_Colorbar_BD.sh [-reset_log]\n\
Usage: DP_Colorbar_BD.sh [-keep_index]\n\
Usage: DP_Colorbar_BD.sh [-noclean_files]\n\n\
