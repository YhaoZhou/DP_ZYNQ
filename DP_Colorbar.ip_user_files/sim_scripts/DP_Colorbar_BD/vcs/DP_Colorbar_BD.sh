...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_15 zynq_ultra_ps_e_vip_v1_0_15 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work zynq_ultra_ps_e_vip_v1_0_15 $vlogan_opts -sverilog +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/ec67/hdl" +incdir+"../../../../DP_Colorbar.gen/sources_1/bd/DP_Colorbar_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DP_Colorbar_BD xil_defaultlib.glbl -o DP_Colorbar_BD_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DP_Colorbar_BD_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DP_Colorbar_BD_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DP_Colorbar_BD_simv.daidir vcs_lib c.obj)
