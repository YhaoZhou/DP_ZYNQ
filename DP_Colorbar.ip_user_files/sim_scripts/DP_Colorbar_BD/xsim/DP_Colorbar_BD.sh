...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L zynq_ultra_ps_e_vip_v1_0_15 -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DP_Colorbar_BD xil_defaultlib.DP_Colorbar_BD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DP_Colorbar_BD -key {Behavioral:sim_1:Functional:DP_Colorbar_BD} -tclbatch cmd.tcl -protoinst "protoinst_files/DP_Colorbar_BD.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DP_Colorbar_BD.wdb xsim.dir libdpi.so)
